                ...
                <form method="post">
                  <div>
                    ...
                    <div class="card-body border-top" id="importFrm" style="display: none;">
                        <div class="row">                        
                          <form action="Department_Import.php" method="post" enctype="multipart/form-data">
                              <div class="col-md-6">
                                  <div class="mb-3 has-danger">
                              ...
                              <div class="col-md-6">
                                <div class="mb-3 has-danger">
                                  <input type="submit" class="btn btn-info text-light" name="importDepartment" value="Import CSV">
                                </div>
                              </div>
                          </form>
                        </div>
