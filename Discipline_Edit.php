    ...
    $result_check = mysqli_query($con, $sql_check);
        ...
        $sql_insert = "UPDATE `discipline` SET `penalty`='$penalty',`reason`='$reason' WHERE `staff_id`='$staff_id'";
        $data = mysqli_query($con, $sql_insert);
        if ($data) {
            echo "<script>alert('Chỉnh sửa thông tin kỷ luật thành công!'); window.location='Discipline.php';</script>";
        } else {
            echo "<script>alert('Chỉnh sửa thông tin kỷ luật thất bại!')</script>";
        }
    }
        ...
        <div class="body-wrapper-inner">
            <div class="container-fluid">
                ...
                <div class="row">                
                    ...
                    <div class="card">
                        <div class="card-body">
                        <h5 class="card-title fw-semibold">Chỉnh sửa thông tin kỷ luật</h5>
                        <div class="row pt-3">
                            <div class="col-md-6">
                        ...
                        <div class="form-actions">
                            ...
                            <button type="submit" name="btnAdd" class="btn btn-info text-light">Chỉnh sửa</button>
